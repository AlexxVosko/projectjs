        ...
        <Container>
            <div className="slider w-50 m-auto">
                ...
                <div className="buttons mt-3">
                    ...
                    <button 
                        className="btn btn-primary me-2"
                        onClick={() => setAutoplay(autoplay => !props.autoplay)}>toggle autoplay</button>
                </div>
            </div>
        </Container>
    )
...
//Дополнительное поведение не затрагивая внутренности
// оборачиваем компонент в обертку с дополнительным поведением
