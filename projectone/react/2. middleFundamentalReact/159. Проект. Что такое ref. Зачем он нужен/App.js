...
class Form extends Component {
   ...
   /* componentDidMount(){
    ...
    // Создание нового поля и помещение ссылки на элемент
    // записывается чистая ссылка (без current)
    setInputRef = elem =>{
        this.myRef = elem;
    }
            ...
            <Container>
                <form className="w-50 border mt-5 p-3 m-auto">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea ref={this.focusFirstTI} className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </form>
            </Container>
        )
