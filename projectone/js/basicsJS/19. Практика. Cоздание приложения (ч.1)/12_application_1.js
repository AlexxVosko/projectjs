...
personalMovieDB.movies[films] = mark; //Лучше записывать в [] - так избавляемся от багов 
personalMovieDB.movies[films1] = mark1; // ключ будет введенная данная из поля
personalMovieDB.movies.films = mark; // ключ будет films
